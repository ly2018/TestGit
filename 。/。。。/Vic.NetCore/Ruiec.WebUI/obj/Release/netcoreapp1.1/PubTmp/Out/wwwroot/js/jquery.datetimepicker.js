    ...
    $.fn.datetimepicker = function (opt) {
        var KEY0 = 48,
			...
			createDateTimePicker = function (input) {
			    ...
			    if ($(".contents_main").size() > 0) {
			        $('.contents_main').append(datetimepicker);
			    } else {
			    ...
			    var setPos = function () {
			        ...
			        var PLen = datetimepicker.parents(".bomb_box").length == undefined ? 0 : datetimepicker.parents(".bomb_box").length;
			        if (offset.left > 185 && PLen < 10) {
