...
{
    public class PlateSettingController : BaseController
    {
        #region 数据接口
        ...
        #region 构造器
        public PlateSettingController(IPlateSettingAppService PlateSettingAppService)
        {
        ...
        {
            PageDataResponse<PlateSettingDto> pageData = new PageDataResponse<PlateSettingDto>();
            var parameterExpression = System.Linq.Expressions.Expression.Parameter(typeof(PlateSetting));
            ...
            var queryLambdaFilter = System.Linq.Expressions.Expression.Lambda<Func<PlateSetting, bool>>(filter, parameterExpression);
            int Count;
            List<PlateSettingDto> List = _PlateSettingAppService.PageList(queryLambdaFilter, pageParams.PageSize, pageParams.CurPage, out Count);
            pageData.Data = List;
        ...
        public JsonResult Delete(string Ids)
        {
            ...
            bool IsSucceed = _PlateSettingAppService.DeleteBatch(delIds);
