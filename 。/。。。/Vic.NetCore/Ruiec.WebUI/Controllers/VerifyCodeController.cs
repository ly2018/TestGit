...
namespace Ruiec.WebUI.Controllers
{
    ...
    {
        #region 数据接口
        private readonly IVerifyCodeAppService _VerifyCodeAppService;
        #endregion

        #region 构造器
        public VerifyCodeController(IVerifyCodeAppService VerifyCodeAppService)
        {
        ...
        {
            PageDataResponse<VerifyCodeDto> pageData = new PageDataResponse<VerifyCodeDto>();
            var parameterExpression = System.Linq.Expressions.Expression.Parameter(typeof(VerifyCode));
            ...
            var queryLambdaFilter = System.Linq.Expressions.Expression.Lambda<Func<VerifyCode, bool>>(filter, parameterExpression);
            int Count;
            List<VerifyCodeDto> List = _VerifyCodeAppService.PageList(queryLambdaFilter, pageParams.PageSize, pageParams.CurPage, out Count);
            pageData.Data = List;
        ...
        public JsonResult Delete(string Ids)
        {
            ...
            bool IsSucceed = _VerifyCodeAppService.DeleteBatch(delIds);
