...
namespace Ruiec.WebUI.Controllers
{
    public class SysLogController : BaseController
    {
        ...
        #region 构造器
        public SysLogController(ISysLogAppService SysLogAppService)
        {
        ...
        {
            PageDataResponse<SysLogDto> pageData = new PageDataResponse<SysLogDto>();
            var parameterExpression = System.Linq.Expressions.Expression.Parameter(typeof(SysLog));
            ...
            var queryLambdaFilter = System.Linq.Expressions.Expression.Lambda<Func<SysLog, bool>>(filter, parameterExpression);
            int Count;
            List<SysLogDto> List = _SysLogAppService.PageList(queryLambdaFilter, pageParams.PageSize, pageParams.CurPage, out Count);
            pageData.Data = List;
        ...
        public JsonResult Delete(string Ids)
        {
            ...
            bool IsSucceed = _SysLogAppService.DeleteBatch(delIds);
