...
namespace Vic.Core.Application.Services
{
    public class ArticleTypeAppService : IArticleTypeAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ArticleTypeDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<ArticleTypeDto>(_repository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("ArticleTypeAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<ArticleTypeDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<ArticleTypeDto>>(_repository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("ArticleTypeAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<ArticleTypeDto> QueryListByReadOnlyDB(Expression<Func<ArticleType, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<ArticleTypeDto>>(_repository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("ArticleTypeAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<ArticleTypeDto> PageListByReadOnlyDB(Expression<Func<ArticleType, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<ArticleTypeDto>>(_repository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("ArticleTypeAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public ArticleTypeDto GetByReadOnlyDB(Expression<Func<ArticleType, bool>> predicate)
        {
            try
            {
                return Mapper.Map<ArticleTypeDto>(_repository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("ArticleTypeAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<ArticleType, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("ArticleTypeAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<ArticleType, bool>> predicate, Expression<Func<ArticleType, object>> selector)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("ArticleTypeAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
		#endregion
