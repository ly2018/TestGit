...
namespace Vic.Core.Application.Services
{
    public class ShortMsgConfigAppService : IShortMsgConfigAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ShortMsgConfigDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<ShortMsgConfigDto>(_repository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("ShortMsgConfigAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<ShortMsgConfigDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<ShortMsgConfigDto>>(_repository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("ShortMsgConfigAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<ShortMsgConfigDto> QueryListByReadOnlyDB(Expression<Func<ShortMsgConfig, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<ShortMsgConfigDto>>(_repository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("ShortMsgConfigAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<ShortMsgConfigDto> PageListByReadOnlyDB(Expression<Func<ShortMsgConfig, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<ShortMsgConfigDto>>(_repository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("ShortMsgConfigAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public ShortMsgConfigDto GetByReadOnlyDB(Expression<Func<ShortMsgConfig, bool>> predicate)
        {
            try
            {
                return Mapper.Map<ShortMsgConfigDto>(_repository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("ShortMsgConfigAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<ShortMsgConfig, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("ShortMsgConfigAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<ShortMsgConfig, bool>> predicate, Expression<Func<ShortMsgConfig, object>> selector)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("ShortMsgConfigAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
		#endregion
