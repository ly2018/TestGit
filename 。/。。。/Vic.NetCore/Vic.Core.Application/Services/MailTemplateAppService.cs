...
namespace Vic.Core.Application.Services
{
    public class MailTemplateAppService : IMailTemplateAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public MailTemplateDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<MailTemplateDto>(_repository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("MailTemplateAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<MailTemplateDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<MailTemplateDto>>(_repository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("MailTemplateAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<MailTemplateDto> QueryListByReadOnlyDB(Expression<Func<MailTemplate, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<MailTemplateDto>>(_repository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("MailTemplateAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<MailTemplateDto> PageListByReadOnlyDB(Expression<Func<MailTemplate, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<MailTemplateDto>>(_repository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("MailTemplateAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public MailTemplateDto GetByReadOnlyDB(Expression<Func<MailTemplate, bool>> predicate)
        {
            try
            {
                return Mapper.Map<MailTemplateDto>(_repository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("MailTemplateAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<MailTemplate, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("MailTemplateAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<MailTemplate, bool>> predicate, Expression<Func<MailTemplate, object>> selector)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("MailTemplateAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
		#endregion
