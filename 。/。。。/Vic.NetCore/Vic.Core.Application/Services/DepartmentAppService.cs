...
namespace Vic.Core.Application.Services
{
    public class DepartmentAppService : IDepartmentAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public DepartmentDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<DepartmentDto>(_repository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("DepartmentAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<DepartmentDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<DepartmentDto>>(_repository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("DepartmentAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<DepartmentDto> QueryListByReadOnlyDB(Expression<Func<Department, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<DepartmentDto>>(_repository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("DepartmentAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<DepartmentDto> PageListByReadOnlyDB(Expression<Func<Department, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<DepartmentDto>>(_repository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("DepartmentAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public DepartmentDto GetByReadOnlyDB(Expression<Func<Department, bool>> predicate)
        {
            try
            {
                return Mapper.Map<DepartmentDto>(_repository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("DepartmentAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<Department, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("DepartmentAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<Department, bool>> predicate, Expression<Func<Department, object>> selector)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("DepartmentAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        #endregion
