...
namespace Vic.Core.Application.Services
{
    public class MenuAppService : IMenuAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public MenuDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<MenuDto>(_menuRepository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("MenuAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<MenuDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<MenuDto>>(_menuRepository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("MenuAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<MenuDto> QueryListByReadOnlyDB(Expression<Func<Menu, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<MenuDto>>(_menuRepository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("MenuAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<MenuDto> PageListByReadOnlyDB(Expression<Func<Menu, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<MenuDto>>(_menuRepository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("MenuAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public MenuDto GetByReadOnlyDB(Expression<Func<Menu, bool>> predicate)
        {
            try
            {
                return Mapper.Map<MenuDto>(_menuRepository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("MenuAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<Menu, bool>> predicate)
        {
            try
            {
                return _menuRepository.CountByReadOnlyDB(predicate);
            }
            catch (Exception ex)
            {

                _log.LogError("MenuAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<Menu, bool>> predicate, Expression<Func<Menu, object>> selector)
        {
            try
            {
                return _menuRepository.QueryPropertyByReadOnlyDB(predicate, selector);
            }
            catch (Exception ex)
            {

                _log.LogError("MenuAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        #endregion
