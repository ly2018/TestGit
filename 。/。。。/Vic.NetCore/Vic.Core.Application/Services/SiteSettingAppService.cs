...
namespace Vic.Core.Application.Services
{
    public class SiteSettingAppService : ISiteSettingAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public SiteSettingDto GetByReadOnlyDB(Guid id)
        {
            try
            {
                return Mapper.Map<SiteSettingDto>(_repository.GetByReadOnlyDB(id));
            }
            catch (Exception ex)
            {
                _log.LogError("SiteSettingAppService GetByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<SiteSettingDto> ListByReadOnlyDB()
        {
            try
            {
                return Mapper.Map<List<SiteSettingDto>>(_repository.GetAllListByReadOnlyDB(it => it.ID != Guid.Empty).OrderByDescending(it => it.CreateTime));
            }
            catch (Exception ex)
            {
                _log.LogError("SiteSettingAppService ListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<SiteSettingDto> QueryListByReadOnlyDB(Expression<Func<SiteSetting, bool>> predicate)
        {
            try
            {
                return Mapper.Map<List<SiteSettingDto>>(_repository.QueryListByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {
                _log.LogError("SiteSettingAppService ListByReadOnlyDB error occured:" + ex.Message);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public List<SiteSettingDto> PageListByReadOnlyDB(Expression<Func<SiteSetting, bool>> predicate, int pageSize, int curPage, out int count)
        {
            try
            {
                return Mapper.Map<List<SiteSettingDto>>(_repository.LoadPageListByReadOnlyDB(curPage, pageSize, out count, predicate, a => a.CreateTime));
            }
            catch (Exception ex)
            {
                count = 0;
                _log.LogError("SiteSettingAppService PageListByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public SiteSettingDto GetByReadOnlyDB(Expression<Func<SiteSetting, bool>> predicate)
        {
            try
            {
                return Mapper.Map<SiteSettingDto>(_repository.FirstOrDefaultByReadOnlyDB(predicate));
            }
            catch (Exception ex)
            {

                _log.LogError("SiteSettingAppService GetByReadOnlyDB lanbuda error occured:" + ex.Message);
                return null;
            }
        }
        /// <summary>
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int CountByReadOnlyDB(Expression<Func<SiteSetting, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("SiteSettingAppService CountByReadOnlyDB error occured:" + ex.Message);
                return 0;
            }
        }
        /// <summary> 
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public IQueryable<object> QueryPropertyByReadOnlyDB(Expression<Func<SiteSetting, bool>> predicate, Expression<Func<SiteSetting, object>> selector)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                _log.LogError("SiteSettingAppService QueryPropertyByReadOnlyDB error occured:" + ex.Message);
                return null;
            }
        }
		#endregion
