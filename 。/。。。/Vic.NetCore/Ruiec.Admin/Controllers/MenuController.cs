...
namespace Ruiec.Admin.Controllers
{
    ...
    public class MenuController : BaseController
    {
        ...
        public MenuController(IMenuAppService menuAppService, Vic.Core.Application.IServices.IUserAppService userAppService)
        {
        ...
        {
            var menus = _menuAppService.ListByReadOnlyDB();
        ...
        public IActionResult Edit(MenuDto dto)
        {
            ...
            if (dto.ID != Guid.Empty ? _menuAppService.Edit(dto) : _menuAppService.Create(dto))
            {
